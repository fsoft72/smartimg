...
function _form_wh($w, $h)
{
?>
	<tr>
		<th scope="row"><?php esc_html_e('Images uploaded within a Page/Post', 'smartimg'); ?></th>
		<td>
			<label for="smartimg_max_width"><?php esc_html_e('Max Width', 'smartimg'); ?></label> <input type="number" step="1" min="0" class='small-text' name="smartimg_max_width" value="<?php echo (int) $w; ?>" />
			<label for="smartimg_max_height"><?php esc_html_e('Max Height', 'smartimg'); ?></label> <input type="number" step="1" min="0" class="small-text" name="smartimg_max_height" value="<?php echo (int) $h; ?>" /> <?php esc_html_e('in pixels, enter 0 to disable', 'smartimg'); ?>
...
function _form_wh_other($w, $h)
{
?>
	<tr>
		<th scope="row"><?php esc_html_e('Images uploaded elsewhere (Theme headers, backgrounds, logos, etc)', 'smartimg'); ?></th>
		<td>
			<label for="smartimg_max_width_other"><?php esc_html_e('Max Width', 'smartimg'); ?></label> <input type="number" step="1" min="0" class='small-text' name="smartimg_max_width_other" value="<?php echo (int) $w; ?>" />
			<label for="smartimg_max_height_other"><?php esc_html_e('Max Height', 'smartimg'); ?></label> <input type="number" step="1" min="0" class="small-text" name="smartimg_max_height_other" value="<?php echo (int) $h; ?>" /> <?php esc_html_e('in pixels, enter 0 to disable', 'smartimg'); ?>
		</td>
	</tr>
...
function _form_quality($quality)
{
?>
	<tr>
		<th scope="row">
		...
		<td>
			<input type='text' id='smartimg_quality' name='smartimg_quality' class='small-text' value='<?php echo (int) $quality; ?>' />
...
function _form_bmp_to_jpg($conv)
{
?>
	<tr>
		<th scope="row">
		...
		<td>
			<input type="checkbox" id="smartimg_bmp_to_jpg" name="smartimg_bmp_to_jpg" value="true" <?php checked($conv); ?> />
...
function _form_png_to_jpg($conv)
{
?>
	<tr>
		<th scope="row">
		...
		<td>
			<input type="checkbox" id="smartimg_png_to_jpg" name="smartimg_png_to_jpg" value="true" <?php checked($conv); ?> />
			<?php esc_html_e('Only applies to new image uploads.', 'smartimg'); ?>
		</td>
	</tr>
<?php
}

function _form_delete_originals($del)
{
?>
	<tr>
		<th scope="row">
		...
		<td>
			<input type="checkbox" id="smartimg_delete_originals" name="smartimg_delete_originals" value="true" <?php checked($del); ?> />
			<?php esc_html_e('Remove the large pre-scaled originals that WordPress retains for thumbnail generation.', 'smartimg'); ?>
		</td>
	</tr>
<?php
}
function _form_always_resize($resize)
{
?>
	<tr>
		<th scope="row">
		...
		<td>
			<input type="checkbox" id="smartimg_always_resize_jpg" name="smartimg_always_resize_jpg" value="true" <?php checked($resize); ?> />
	...
	<div class="wrap">
		...
		<form method="post" action="">
			...
			<table class="form-table">
				...
				<?php
				_form_wh($settings->smartimg_max_width_library, $settings->smartimg_max_height_library);
				_form_wh_other($settings->smartimg_max_width_other, $settings->smartimg_max_height_other);
				_form_quality($settings->smartimg_quality);
				_form_bmp_to_jpg($settings->smartimg_bmp_to_jpg);
				_form_png_to_jpg($settings->smartimg_png_to_jpg);
				_form_delete_originals($settings->smartimg_delete_originals);
				_form_always_resize($settings->smartimg_always_resize_jpg);
				?>
			</table>
...
function smartimg_settings_page_form()
{
	?>
		<form method="post" action="options.php">
			...
			<table class="form-table">
				<?php
				_form_wh(get_option('smartimg_max_width', SMARTIMG_DEFAULT_MAX_WIDTH), get_option('smartimg_max_height', SMARTIMG_DEFAULT_MAX_HEIGHT));
				_form_wh_library(get_option('smartimg_max_width_library', SMARTIMG_DEFAULT_MAX_WIDTH), get_option('smartimg_max_height_library', SMARTIMG_DEFAULT_MAX_HEIGHT));
				_form_wh_other(get_option('smartimg_max_width_other', SMARTIMG_DEFAULT_MAX_WIDTH), get_option('smartimg_max_height_other', SMARTIMG_DEFAULT_MAX_HEIGHT));
				_form_quality(smartimg_jpg_quality());
				_form_bmp_to_jpg(get_option('smart_bpm_to_jpg', SMARTIMG_DEFAULT_BMP_TO_JPG));
				_form_png_to_jpg(get_option('smart_png_to_jpg', SMARTIMG_DEFAULT_PNG_TO_JPG));
				_form_delete_originals(get_option('smartimg_delete_originals'));
				_form_always_resize(get_option('smartimg_always_resize_jpg'));
				?>
			</table>
